...
const outputPath = join(rootDir, 'oh-my-kilocode-slim.schema.json');
...
const jsonSchema = {
  ...
  title: 'oh-my-kilocode-slim',
  description:
    'Configuration schema for oh-my-kilocode-slim plugin for KiloCode',
};
